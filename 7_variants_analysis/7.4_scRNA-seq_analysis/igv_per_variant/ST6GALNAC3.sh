#!/usr/bin/env bash
# IGV.js (navegador) para a variante ST6GALNAC3.
...
# Uso: bash igv_per_variant/ST6GALNAC3.sh   (requer samtools + str_samples_bams.tsv)
set -u

GENE="ST6GALNAC3"; PORT="8208"; FLANK=1000
